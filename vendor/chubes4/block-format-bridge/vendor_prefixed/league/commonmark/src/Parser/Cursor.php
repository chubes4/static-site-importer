...
use BlockFormatBridge\Vendor\League\CommonMark\Exception\UnexpectedEncodingException;
class Cursor
{
    ...
    public function advanceBy(int $characters, bool $advanceByColumns = \false): void
    {
        ...
        $nextFewChars = $this->isMultibyte ? \mb_substr($this->line, $this->currentPosition, $characters, 'UTF-8') : \substr($this->line, $this->currentPosition, $characters);
        if ($characters === 1) {
    ...
    public function getRemainder(): string
    {
        ...
        $subString = $this->isMultibyte ? \mb_substr($this->line, $position, null, 'UTF-8') : \substr($this->line, $position);
    ...
    {
        return new CursorState([$this->currentPosition, $this->previousPosition, $this->nextNonSpaceCache, $this->indent, $this->column, $this->partiallyConsumedTab]);
    }
    /**
    ...
    {
        [$this->currentPosition, $this->previousPosition, $this->nextNonSpaceCache, $this->indent, $this->column, $this->partiallyConsumedTab] = $state->toArray();
    }
