 ...
 */
namespace BlockFormatBridge\Vendor\League\CommonMark;
...
use BlockFormatBridge\Vendor\League\CommonMark\Renderer\HtmlRenderer;
use BlockFormatBridge\Vendor\League\CommonMark\Renderer\MarkdownRendererInterface;
class MarkdownConverter implements ConverterInterface, MarkdownConverterInterface
{
    ...
    {
        \BlockFormatBridge\Vendor\trigger_deprecation('league/commonmark', '2.2.0', 'Calling "convertToHtml()" on a %s class is deprecated, use "convert()" instead.', self::class);
