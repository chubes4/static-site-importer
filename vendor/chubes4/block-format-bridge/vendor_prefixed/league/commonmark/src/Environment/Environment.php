...
use BlockFormatBridge\Vendor\League\CommonMark\Delimiter\DelimiterParser;
use BlockFormatBridge\Vendor\League\CommonMark\Delimiter\Processor\DelimiterProcessorCollection;
...
use BlockFormatBridge\Vendor\League\CommonMark\Event\ListenerData;
use BlockFormatBridge\Vendor\League\CommonMark\Exception\AlreadyInitializedException;
use BlockFormatBridge\Vendor\League\CommonMark\Extension\CommonMark\CommonMarkCoreExtension;
...
use BlockFormatBridge\Vendor\League\CommonMark\Extension\GithubFlavoredMarkdownExtension;
use BlockFormatBridge\Vendor\League\CommonMark\Normalizer\SlugNormalizer;
use BlockFormatBridge\Vendor\League\CommonMark\Normalizer\TextNormalizerInterface;
use BlockFormatBridge\Vendor\League\CommonMark\Normalizer\UniqueSlugNormalizer;
use BlockFormatBridge\Vendor\League\CommonMark\Normalizer\UniqueSlugNormalizerInterface;
use BlockFormatBridge\Vendor\League\CommonMark\Parser\Block\BlockStartParserInterface;
use BlockFormatBridge\Vendor\League\CommonMark\Parser\Block\SkipLinesStartingWithLettersParser;
...
use BlockFormatBridge\Vendor\League\CommonMark\Util\HtmlFilter;
use BlockFormatBridge\Vendor\League\CommonMark\Util\PrioritizedList;
use BlockFormatBridge\Vendor\League\Config\Configuration;
...
use BlockFormatBridge\Vendor\Psr\EventDispatcher\ListenerProviderInterface;
use BlockFormatBridge\Vendor\Psr\EventDispatcher\StoppableEventInterface;
final class Environment implements EnvironmentInterface, EnvironmentBuilderInterface, ListenerProviderInterface
{
    ...
    private function initializeExtensions(): void
    {
        ...
        $this->extensionsInitialized = \true;
