...
namespace BlockFormatBridge\Vendor\League\CommonMark\Extension\FrontMatter\Output;

use BlockFormatBridge\Vendor\League\CommonMark\Extension\FrontMatter\FrontMatterProviderInterface;
use BlockFormatBridge\Vendor\League\CommonMark\Node\Block\Document;
use BlockFormatBridge\Vendor\League\CommonMark\Output\RenderedContent;
/**
 * @psalm-immutable
 */
