...
namespace BlockFormatBridge\Vendor\League\CommonMark\Extension\Footnote;
...
use BlockFormatBridge\Vendor\League\CommonMark\Extension\Footnote\Event\AnonymousFootnotesListener;
use BlockFormatBridge\Vendor\League\CommonMark\Extension\Footnote\Event\FixOrphanedFootnotesAndRefsListener;
use BlockFormatBridge\Vendor\League\CommonMark\Extension\Footnote\Event\GatherFootnotesListener;
use BlockFormatBridge\Vendor\League\CommonMark\Extension\Footnote\Event\NumberFootnotesListener;
use BlockFormatBridge\Vendor\League\CommonMark\Extension\Footnote\Node\Footnote;
use BlockFormatBridge\Vendor\League\CommonMark\Extension\Footnote\Node\FootnoteBackref;
use BlockFormatBridge\Vendor\League\CommonMark\Extension\Footnote\Node\FootnoteContainer;
use BlockFormatBridge\Vendor\League\CommonMark\Extension\Footnote\Node\FootnoteRef;
use BlockFormatBridge\Vendor\League\CommonMark\Extension\Footnote\Parser\AnonymousFootnoteRefParser;
use BlockFormatBridge\Vendor\League\CommonMark\Extension\Footnote\Parser\FootnoteRefParser;
use BlockFormatBridge\Vendor\League\CommonMark\Extension\Footnote\Parser\FootnoteStartParser;
use BlockFormatBridge\Vendor\League\CommonMark\Extension\Footnote\Renderer\FootnoteBackrefRenderer;
use BlockFormatBridge\Vendor\League\CommonMark\Extension\Footnote\Renderer\FootnoteContainerRenderer;
use BlockFormatBridge\Vendor\League\CommonMark\Extension\Footnote\Renderer\FootnoteRefRenderer;
