...
namespace BlockFormatBridge\Vendor\League\CommonMark\Extension\Attributes\Parser;
...
final class AttributesBlockContinueParser extends AbstractBlockContinueParser
{
    ...
    public function tryContinue(Cursor $cursor, BlockContinueParserInterface $activeBlockParser): ?BlockContinue
    {
        ...
        if ($cursor->isAtEnd() && $attributes !== []) {
            ...
            $this->block->setAttributes(AttributesHelper::mergeAttributes($this->block->getAttributes(), $attributes));
