...
class Arrays
{
    ...
    {
        return Helpers::falseToNull(array_search(self::toKey($key), array_keys($array), strict: \true));
    }
    /**
     * @param  array<mixed>  $array
    ...
    {
        return in_array($value, $array, strict: \true);
    }
    /**
    ...
    {
        return $predicate ? self::firstKey(array_reverse($array, preserve_keys: \true), $predicate) : array_key_last($array);
    }
    /**
    ...
    public static function insertAfter(array &$array, string|int|null $key, array $inserted): void
    {
        ...
        $array = array_slice($array, 0, $offset + 1, preserve_keys: \true) + $inserted + array_slice($array, $offset + 1, count($array), preserve_keys: \true);
    }
    /**
