...
$assert( str_starts_with( trim( $fallback_content ), '<script' ), 'fallback-starts-at-script', $fallback_content );
$assert( str_ends_with( trim( $fallback_content ), '</script>' ), 'fallback-ends-at-script', $fallback_content );
