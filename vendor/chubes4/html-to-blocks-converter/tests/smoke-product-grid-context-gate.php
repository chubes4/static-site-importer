...
$expected_context_enabled_shape = [
	...
	'notes'       => 'Preserve static editable placeholders until SSI or another importer materializes product state.',
];
...
$assert( ! in_array( 'core/html', $names, true ), 'product-grid-does-not-fallback-to-core-html', $name_list );
