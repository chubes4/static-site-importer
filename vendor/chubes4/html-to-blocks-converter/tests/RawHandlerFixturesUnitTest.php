	...
	private function supported_fixtures(): array {
		return array(
			...
			'separator'        => array(
				...
				'snippets'       => array( 'wp-block-separator' ),
			),
			'table'            => array(
