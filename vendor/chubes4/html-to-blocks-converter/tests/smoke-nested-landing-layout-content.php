...
HTML,
		'expected' => [
			...
			'Gutenberg is a <span style="color:var(--accent-2)">detour.</span>',
			'Old Way: Block Editor Hell',
			'Drag-and-drop interfaces that fight you',
			'Global styles vs. inline styles vs. theme.json',
			'Studio Code Way: Pure HTML',
			'AI agents can generate real content',
...
HTML,
		'expected' => [
			...
			'&lt;/&gt;',
			'Write HTML, Ship WordPress',
			'without touching a block schema',
			'~~',
			'Vibe Code With AI',
			'No more "block validation failed" errors',
		],
	],
];
...
foreach ( $fixtures as $name => $fixture ) {
	...
	$assert( ! in_array( 'core/html', $names, true ), $name . '-does-not-fallback-to-core-html' );
	$assert( in_array( 'core/group', $names, true ), $name . '-uses-groups-for-wrappers' );
