...
$assert( ! in_array( 'core/html', $names, true ), 'timeline-does-not-use-core-html', implode( ', ', $names ) );
...
foreach ( [
	...
	'02 &mdash; Convert',
	'03 &mdash; Edit',
	'Describe your site in plain HTML',
	'Studio converts it to blocks',
	'Refine in the Site Editor',
	'Use any HTML you like',
	'Studio Code intelligently maps your HTML structure',
	'Every converted block is fully editable',
] as $expected ) {
