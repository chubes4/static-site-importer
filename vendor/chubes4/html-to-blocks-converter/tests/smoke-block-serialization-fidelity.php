...
$paragraph = HTML_To_Blocks_Block_Factory::create_block(
	'core/paragraph',
	[
		'content'   => 'A generated static website.',
		'className' => 'lede',
	]
);
...
$heading = HTML_To_Blocks_Block_Factory::create_block(
	...
	[
		'level'     => 1,
		'content'   => 'WordPress is officially dead.',
		'className' => 'hero-title',
	]
);

$group = HTML_To_Blocks_Block_Factory::create_block(
	'core/group',
	[
		'className' => 'hero',
		'tagName'   => 'section',
...
$list = HTML_To_Blocks_Block_Factory::create_block(
	...
	[
		HTML_To_Blocks_Block_Factory::create_block( 'core/list-item', [ 'content' => 'One' ] ),
	]
);

$preformatted = HTML_To_Blocks_Block_Factory::create_block(
	'core/preformatted',
	[
		'content'   => '<span class="label">The Prompt</span>Generate a site.',
		'className' => 'prompt',
	]
);
