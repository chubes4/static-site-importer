...
$assert( ! in_array( 'core/html', $names, true ), 'stat-cards-do-not-use-core-html', implode( ', ', $names ) );
...
$assert( in_array( 'core/html', $unsafe_names, true ), 'unsafe-widget-still-falls-back', implode( ', ', $unsafe_names ) );
