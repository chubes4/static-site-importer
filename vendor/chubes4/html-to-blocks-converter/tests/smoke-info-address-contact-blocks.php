...
HTML,
		'expected' => [
			'Hours',
			'<span class="day">Tuesday &ndash; Friday</span><span>7:00 am &ndash; 3:00 pm</span>',
			'<span class="day">Saturday</span><span>7:00 am &ndash; 2:00 pm</span>',
			'<span class="day">Sunday</span><span>8:00 am &ndash; 1:00 pm</span>',
			'<span class="day">Monday</span><span>Closed</span>',
		],
	],
	'contact' => [
		'html'     => <<<'HTML'
...
HTML,
		'expected' => [
			...
			'412 King Street<br>',
			'Charleston, SC 29403',
			'href="tel:+18435550192"',
			'+1 (843) 555-0192',
			'href="mailto:hello@saltandstar.com"',
...
foreach ( $fixtures as $name => $fixture ) {
	...
	$assert( ! in_array( 'core/html', $names, true ), $name . '-does-not-fallback-to-core-html', $serialized );
	$assert( in_array( 'core/group', $names, true ), $name . '-uses-group-for-info-wrapper', implode( ',', $names ) );
	$assert( in_array( 'core/heading', $names, true ), $name . '-heading-block-created', implode( ',', $names ) );
