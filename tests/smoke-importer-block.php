...
$assert( str_contains( $html, 'Choose file(s) or ZIP' ), 'render-has-file-or-zip-upload-affordance' );
...
$assert( str_contains( $view_js, 'archive: await buildArchive( uploadInputs )' ), 'view-sends-zip-from-combined-upload-as-archive-payload' );
