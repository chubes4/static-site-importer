...
class StaticSiteImporterFixtureTest extends WP_UnitTestCase {
	...
	public function test_relay_atlas_logo_anchor_fixture_imports_without_html_islands(): void {
		...
		$this->assertStringNotContainsString( '<p><a href="#" class="footer-brand"><div', $footer );
		$this->assertStringContainsString( 'href="#"', $header );
		$this->assertStringContainsString( '<a href="#" class="logo">', $header );
		$this->assertStringNotContainsString( '"className":"logo"', $header );
		...
		$this->assertStringContainsString( '<a href="#" class="footer-brand">', $footer );
		$this->assertStringNotContainsString( '"className":"footer-brand"', $footer );
		$this->assertStringContainsString( 'footer-logo-mark', $footer );
		$this->assertStringContainsString( 'class="footer-wordmark"', $footer );
