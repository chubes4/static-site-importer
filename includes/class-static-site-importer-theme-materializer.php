...
class Static_Site_Importer_Theme_Materializer {
	 ...
	 */
	public static function base_theme_writes( string $theme_dir, string $theme_slug, string $theme_name, string $css, bool $has_footer_part, array $scripts = array(), array $stylesheets = array() ): array {
		return array(
